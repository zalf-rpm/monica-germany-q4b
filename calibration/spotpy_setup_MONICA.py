...
class spot_setup(object):
    def __init__(self, user_params, sim_map, observations, calibration_target, dumped_envs_folder):
        ...
        self.monica_model = MONICA_adapter.monica_adapter(sim_map, observations, calibration_target, dumped_envs_folder)
